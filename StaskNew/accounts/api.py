...
from .serializers import UserSerializer, RegisterSerializer, LoginSerializer, ProjectUsersSerializer, GetUserDataSerializer
...
class ProjectUsersView(viewsets.ReadOnlyModelViewSet):
    permission_classes = [
        permissions.IsAuthenticated,
    ]
